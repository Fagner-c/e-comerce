export function produtos_roupas(products){
    ...
    const novaDiv_pr = document.createElement('div');
    novaDiv_pr.className = 'card-Produtos';
    ...
    for (let i = 0; i < products.length; i++) {
        if(products[i].category == "Roupa"){
            const product = products[i];
            novaDiv_pr.innerHTML += `
    ...
    sectionAlvo.appendChild(novaDiv_pr);
}
